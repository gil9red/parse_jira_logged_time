...
- Аддоны. Добавлен аддон "Занятые порты", который показывает занятые локальными серверами порты
- Аддоны. Добавлено поле url. Добавлена кнопка открытия ссылки в браузере
- Аддоны. GUI. У кнопки обновления убрана рамка границы
- Аддоны. Добавлен аддон "Калькулятор времени"
- Аддоны. Добавлен аддон "Тетрис"
...
- GUI: Аддоны. Добавлен аддон "Глаза"
